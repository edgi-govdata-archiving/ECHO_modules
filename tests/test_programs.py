...
data_sets = make_data_sets([
    ...
    "CAA Penalties",
    "CAA Inspections",
    "Combined Air Emissions", # Currently not working for Neighborhoods
...
for p in [#data_sets['CWA Violations'],
        ...
        #data_sets['Combined Air Emissions'] # Failing for unknown reason
        ]:
...
# API false should NOT work without local copy of schema and data
data_sets = make_data_sets([
    "CAA Violations",
    "CAA Penalties",
    "CAA Inspections",
